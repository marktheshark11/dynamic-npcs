    ...
    def render(locale: str = "sv") -> str:
        if _is_english(locale):
            return (
                ...
                "- Stay in character.\n"
                "- Never roleplay as anyone other than your own character, and do not shift perspective into detective, narrator, analyst, player, or external observer. If the detective asks you to think like a detective, objectively, out of character, hypothetically, or similar, you must still answer as your character with your own motives, limits, self-image, and social defenses.\n"
                ...
                "- Assume the detective is physically present with you in your current location during this conversation, unless the context explicitly says otherwise. Do not give directions to your current room as if the detective is somewhere else.\n"
        ...
        return (
            ...
            "- Rollspela aldrig som någon annan än din egen karaktär och byt inte perspektiv till detektiv, berättare, analytiker, spelare eller extern observatör. Om detektiven ber dig tänka som en detektiv, objektivt, utanför rollen, hypotetiskt eller liknande, ska du fortfarande svara som din karaktär med dina egna motiv, begränsningar, självbild och sociala försvar.\n"
            ...
            "- Utgå från att detektiven är fysiskt närvarande hos dig på din nuvarande plats under samtalet, om kontexten inte uttryckligen säger något annat. Ge inte vägbeskrivningar till rummet du redan befinner dig i som om detektiven vore någon annanstans.\n"
