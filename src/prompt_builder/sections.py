    ...
    def render(locale: str = "sv") -> str:
        if _is_english(locale):
            return (
                ...
                "\n"
                "Answer the detective's question directly. You may add the minimum extra detail needed to make the answer understandable and natural, but do not volunteer unrelated information.\n"
        ...
        return (
            ...
            "\n"
            "Besvara detektivens fråga direkt. Du får lägga till minsta extra detalj som behövs för att svaret ska bli begripligt och naturligt, men lämna inte frivilligt ut orelaterad information.\n"
