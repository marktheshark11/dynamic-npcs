    ...
    def render(locale: str = "sv") -> str:
        if _is_english(locale):
            return (
                ...
                "\n"
                "- When the detective asks a question, answer it directly. If no question has been asked yet, give only a short in-character opening line. You may add the minimum extra detail needed to make the answer understandable and natural, but do not volunteer unrelated information.\n"
                ...
                "\n"
                "- A claim may only be used if you express its full meaning in your response.\n"
                "- Never mention only part of a claim, and never imply that the detective learned something that you did not clearly state.\n"
                "- If a claim cannot be expressed fully and naturally, do not use it.\n"
                "\n"
                ...
                "- Only do this when you can express every included claim completely enough for the detective to have clearly learned it.\n"
                "\n"
        ...
        return (
            ...
            "\n"
            "- När detektiven ställer en fråga ska du besvara den direkt. Om ingen fråga har ställts ännu ska du bara ge en kort öppningsreplik i karaktär. Du får lägga till minsta extra detalj som behövs för att svaret ska bli begripligt och naturligt, men lämna inte frivilligt ut orelaterad information.\n"
            ...
            "\n"
            "- En claim får bara användas om du uttrycker hela dess innebörd i ditt svar.\n"
            "- Nämn aldrig bara en del av en claim, och antyd aldrig att detektiven har fått veta något som du inte tydligt har sagt.\n"
            "- Om en claim inte kan uttryckas helt och naturligt, ska du inte använda den.\n"
            "\n"
            ...
            "- Gör det bara när du kan uttrycka varje claim i kedjan tillräckligt fullständigt för att detektiven tydligt ska ha lärt sig den.\n"
            "\n"
    ...
    def render(locale: str = "sv") -> str:
        if _is_english(locale):
            return (
                ...
                "- If no available claim can be expressed fully enough to answer the question, say that you do not know and use an empty list [].\n"
                "- Reply in English."
            )
        return (
            "SVARFORMAT (viktigt):\n"
            ...
            "- Om ingen tillgänglig claim kan uttryckas tillräckligt fullständigt för att besvara frågan, säg att du inte vet och använd en tom lista [].\n"
            "- Svara på svenska."
        )
    ...
    def render(request: PromptRequest) -> str:
        ...
        if _is_english(request.locale):
            ...
            return (
                ...
                "Speak as the NPC only. Address the detective directly. Do not speak as the detective, do not write the detective's lines, and do not start interviewing the detective."
        ...
        return (
            ...
            "Tala bara som NPC:n. Rikta dig direkt till detektiven. Tala inte som detektiven, skriv inte detektivens repliker och börja inte förhöra detektiven."
            f"{memory_instruction}"
        )
    ...
    def render(request: PromptRequest) -> str:
        ...
        if _is_english(request.locale):
            if request.scene_event == "detective_enters_room":
                ...
                return (
                    ...
                    "Write exactly one short opening utterance as the NPC. Do not write the detective's words or actions.\n"
                    "RESPONSE:"
                )
            return (
        ...
        if request.scene_event == "detective_enters_room":
            ...
            return (
                ...
                f"{opening_instruction}"
                "Skriv exakt en kort öppningsreplik som NPC:n. Skriv inte detektivens ord eller handlingar.\n"
                "SVAR:"
            )
        return (
