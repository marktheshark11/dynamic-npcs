...
class DirectRAGPipeline(ChatPipeline):
    pipeline_id = "direct_rag"
    ...
    def run(
        ...
        return PipelineRunResult(
            ...
            exchange_trace=ExchangeTrace(
                ...
                selected_claim_ids=self.extract_available_claim_ids(chain_metadata),
                selected_important_claim_ids=self.extract_available_important_claim_ids(chain_metadata),
