        ...
        *,
        ...
        if cls._is_english(locale):
            instruction = (
                ...
                "subject is exactly the speaking NPC. If a claim mentions another person, "
                "keep that person as another person.\n"
                "Do not rewrite other character names. Do not change ownership of rooms, "
                "objects, relationships, or possessions unless the listed claim explicitly "
                "says they belong to the speaking NPC.\n"
                "Never change who died, who was married to whom, who is whose child, or who "
                "owns or has access to something. Prefer removing a claim ID over rewriting "
                "the response in a way that changes perspective, identity, ownership, or "
                "relationships.\n"
            ...
            instruction = (
                ...
                "det behövs.\n"
                "Skriv inte om ett tredjepersonssubjekt i en claim till jag-perspektiv om "
                "subjektet inte exakt är den talande NPC:n. Om en claim nämner en annan "
                "person, behåll den personen som en annan person.\n"
                "Skriv inte om andra karaktärers namn. Ändra inte ägande av rum, föremål, "
                "relationer eller tillhörigheter om den listade claimen inte uttryckligen "
                "säger att de tillhör den talande NPC:n.\n"
                "Ändra aldrig vem som dog, vem som var gift med vem, vem som är vems barn, "
                "eller vem som äger eller har tillgång till något. Ta hellre bort ett "
                "claim-ID än att skriva om svaret på ett sätt som ändrar perspektiv, "
                "identitet, ägande eller relationer.\n"
