                ...
                events.append(
                    self._make_event(
                        ...
                        payload={
                            ...
                            "pipeline_id": exchange.get("pipeline_id"),
                            "search_query": exchange.get("search_query"),
                            "candidate_claim_count": exchange.get("candidate_claim_count"),
                            "selected_claim_count": exchange.get("selected_claim_count"),
                            "used_claim_count": exchange.get("used_claim_count"),
                            "candidate_claim_ids": exchange.get("candidate_claim_ids") or [],
                            "candidate_important_claim_ids": exchange.get("candidate_important_claim_ids") or [],
                            "selected_claim_ids": exchange.get("selected_claim_ids") or [],
                            "selected_important_claim_ids": exchange.get("selected_important_claim_ids") or [],
                            "used_claim_ids": exchange.get("used_claim_ids") or [],
                            "used_important_claim_ids": exchange.get("used_important_claim_ids") or [],
                            "remembered_claim_count": exchange.get("remembered_claim_count"),
                            "selector_strategy": exchange.get("selector_strategy"),
                            "retrieval_latency_ms": exchange.get("retrieval_latency_ms"),
                            "llm_latency_ms": exchange.get("llm_latency_ms"),
                            "total_latency_ms": exchange.get("total_latency_ms"),
